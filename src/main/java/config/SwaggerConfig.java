...
public class SwaggerConfig {
    ...
    private static final String API_NAME = "Olympic API 명세";
    private static final String API_VERSION = "0.0.1";
    private static final String API_DESCRIPTION = "Olaympic API 명세서입니다.";
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("kr.co.olympic"))
