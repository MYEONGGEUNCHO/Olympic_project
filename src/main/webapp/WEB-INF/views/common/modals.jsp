		...
		<div class="modal-content">
			...
			<div class="row justify-content-center">
			    <div class="text-center mb-7">
			        <div class="mb-2"><strong>보유 포인트:</strong> ${login.point}p</div>
			        <div><strong>구매 후 포인트:</strong> <span class="fw-bolder" id="after">0p</span></div>
			    </div>
...
<div id="modal-agree1" class="modal">
	<div class="modal-content">
	    ...
	    <div class="modal-body">
			...
			<p>
			    ① “몰”은 이용자로부터 재화 등을 반환받은 경우 3영업일 이내에 이미 지급받은 재화 등의 대금을 환급합니다. 이 경우 “몰”이 이용자에게 재화등의 환급을 지연한 때에는 그 지연기간에 대하여 「전자상거래 등에서의 소비자보호에 관한 법률 시행령」제21조의2에서 정하는 지연이자율을 곱하여 산정한 지연이자를 지급합니다.
			</p>
			<p>
...
<div id="modal-agree2" class="modal">
	<div class="modal-content">
		...
		<p><strong>파기절차:</strong> 귀하가 회원가입 등을 위해 입력하신 정보는 목적이 달성된 후 별도의 DB로 옮겨져(종이의 경우 별도의 서류함) 내부 방침 및 기타 관련 법령에 의한 정보보호 사유에 따라(보유 및 이용기간 참조) 일정 기간 저장된 후 파기되어집니다. 별도 DB로 옮겨진 개인정보는 법률에 의한 경우가 아니고서는 보유되어지는 이외의 다른 목적으로 이용되지 않습니다.</p>
		<p><strong>파기방법:</strong> 전자적 파일형태로 저장된 개인정보는 기록을 재생할 수 없는 기술적 방법을 사용하여 삭제합니다.</p>
		...
		<ul>
		    <li>개인분쟁조정위원회 (<a href="http://www.1336.or.kr">www.1336.or.kr</a> / 1336)</li>
		    <li>정보보호마크인증위원회 (<a href="http://www.eprivacy.or.kr">www.eprivacy.or.kr</a> / 02-580-0533~4)</li>
		    <li>대검찰청 인터넷범죄수사센터 (<a href="http://icic.sppo.go.kr">icic.sppo.go.kr</a> / 02-3480-3600)</li>
