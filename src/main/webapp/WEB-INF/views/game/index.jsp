			...
			<c:forEach var="vo" items="${map.list }">
				<div>
					...
					<c:if test="${vo.favorite == 0}">
						<i class="fa-regular fa-heart" style="color: #4f4f4f;"></i>
					</c:if>
					<c:if test="${vo.favorite == 1}">
						<i class="fa-solid fa-heart" style="color: #f51919;"></i>
					</c:if>
				</div>
			</c:forEach>
		</div>
