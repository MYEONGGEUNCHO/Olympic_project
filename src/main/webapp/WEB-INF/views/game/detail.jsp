					...
					<div class="col-12">
						<div class="row">
							<div class="col-12 col-md-6">
								...
								<!-- 								유튜브 영상 -->
								<div>
									<iframe width="100%" height="315" src="https://www.youtube.com/embed/Z1HT0E1-RFQ?si=eLSgTo6Uv-_cY9P-&amp;controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
								</div>
							</div>
							<div class="col-12 col-md-6 ps-lg-10">
								...
								<h4>경기장</h4>
								<span>
									📍 ${game.stadium_name}<br>(${game.stadium.stadium_position})
								</span>
								...
								<div style="position: relative; width: 100%; overflow: hidden;">
									...
									<div style="position: absolute; top: 0; left: 0; width: 40%; text-align: left; font-size: 1.5em; color: black; padding: 3px;">좌석 등급 배치도</div>
								</div>
