...
<style>
    ...
    .modal {
        ...
        height: 100%;
        overflow: auto;
        background-culor: rgba(0, 0, 0, 0.4);
    }

    .modal-content {
        background-culor: #fefefe;
        margin: 15% auto;
        padding: 20px;
...
<body>
    ...
    <div id="register_agree">
        <h3>약관 동의</h3>
        <form name="fregister" id="fregister" action="https://moden939.gabia.io/bbs/register_form2.php" onsubmit="return fregister_submit(this);" method="POST" autocomplete="off">
            ...
            <section id="fregister_term">
                <div class="fregister_agree2 checks2">
                    ...
                    <a href="#" class="view-agreement" data-target="#modal-agree11">자세히 보기</a>
                </div>
                <div id="modal-agree11" class="modal">
            ...
            <section>
            	<div class="fregister_agree2 checks2">
                    ...
                    <a href="#" class="view-agreement" data-target="#modal-agree21">자세히 보기</a>
                </div>
                <div id="modal-agree21" class="modal">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3>개인정보처리방침</h3>
                            <span class="close">&times;</span>
